...
- 👀 Já trabalhei com frontend (Fullstack) usando Angular e React e trabalhei com mobile (Xamarin.Forms).
- 💿 Conhecimento sólido com bancos SQL e já trabalhei com NoSQL (MongoDB, DynamoDB).
- 🧐 Tenho curiosidade de conhecer stacks diferentes, tenho alguns projetos em várias stacks ( ex.: Groovy, React Native, Vue, etc).
...
## 👨🏻‍🎓 Formations
 ...
 - **Pós Graduação:** FIAP - I.A para Devs., Março de 2025 - Março de 2026.

## 💼 Empresas onde jé trabalhei:
<p align="left">
